...
KEY_TO_SOURCE: Dict[str, Tuple[str, Optional[str]]] = {
    "N":  ("sequential_tasks/data/language_data_complete_navigation.json",   None),
    "E":  ("sequential_tasks/data/language_data_complete_exploration.json", None),
    "F":  ("sequential_tasks/data/language_data_complete_idle.json",    None),

    # special file that contains {"small":[…], "wide":[…]}
    "P1": ("sequential_tasks/data/language_data_complete_flag_defense.json", "small"),   # becomes key "P1"
    "P2": ("sequential_tasks/data/language_data_complete_flag_defense.json", "wide"),    # becomes key "P2"
}

OUTPUT_FILE = "sequential_tasks/data/merged.json"
